      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="space-y-4">
            <div className="text-2xl font-bold tracking-tight text-[#576CBC]">
              Christian Ardena
            </div>
              ...
              {quickLinks.map(link => (
                <li key={link.name}>
                  <button
                    ...
                    className="text-white/70 hover:text-[#576CBC] transition-colors"
                  >
                    {link.name}
                  </button>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/70">
              <li className="hover:text-[#576CBC] transition-colors">
                <a href="mailto:christian.ardenya@gmailc.om">christian.ardenya@gmailc.om</a>
              </li>
              <li className="hover:text-[#576CBC] transition-colors">
                <a href="tel:+94777777777">+639 38** *****</a>
              </li>
        ...
        <div className="pt-8 mt-12 text-sm text-center border-t border-white/10 text-white/50">
          © {new Date().getFullYear()} ChristianArdena. All rights reserved.
        </div>
      </div>
    </footer>
  )
